                     ...
                     <div class="col-md-8 col-sm-12 col-xs-12"
                        ...
                        <div class="single-blog">
                           ...
                           <div class="blog-content">
                              ...
                              <h3>방문후원자 세부사항</h3>
                              <span>성함: </span> <span>${ sponsor.name }</span> <br> <span>거주지역:</span>
                                 <span>${ sponsor.address.address1 }${ sponsor.address.address_detail }(우편번호:${ sponsor.address.zipcode })
                                 <br> lat:${ sponsor.address.location.lat }/lng:${ sponsor.address.location.lng }</span><br> 
                                 
                                 <span>연락처:</span> <span>${ sponsor.phone}</span> <br> <span>장애등급:</span>
                                 <span><c:choose>
