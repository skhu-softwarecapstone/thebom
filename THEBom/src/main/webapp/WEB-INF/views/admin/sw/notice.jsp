...
<body data-target="#nino-navbar" data-spy="scroll">
	...
	<section id="portfolio" class="section archive page"
		style="min-height: 100%; height: 666px;">
		<div class="container" style="min-height: 100%;">
			<div class="row">
				<h3 style="color: gray">
					...
					<h6 style="color: gray">
						더불어돌봄 관리자 공지사항 게시판입니다
						</h4>
						<div class="pull-right mb5">
							<a href="notice_write" class="btn btn-info search-button"> <span
								class="glyphicon glyphicon-user"></span> 공지사항 등록
							</a>
						</div>
						<!-- Start table -->
	...
	<!-- Footer
    ================================================== -->
	<footer id="footer" style="height: 100px;"> </footer>
	<!--/#footer-->
