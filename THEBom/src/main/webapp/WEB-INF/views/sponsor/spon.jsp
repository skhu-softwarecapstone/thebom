					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						...
						<div data-url="manage_detail?id=1" class="portfolio-single">
							...
							<div class="text">
								...
								<button class="btn btn-default search-button" data-target="#apply" data-toggle="modal" style="margin:10px;">신청</button>
							 ...
							 <div class="modal-content" style="width:70%; left: 15%;">
							  ...
							  <div class="modal-body">
								...
								<thead>
									<tr>
										<th colspan="2"
											style="background-color: #eeeeee; text-align: center;">후원 신청하기</th>
									</tr>
								</thead>
								<tbody>
									<tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control"  name="visitWeek"/></td>
									</tr>
									<tr>
										<td><label>방문 선호 시간</label></td>
										<td><input type="text" class="form-control" name="visitTime" maxlength="50"/></td>
									</tr>
								</tbody>
							</table>	
								</div>
