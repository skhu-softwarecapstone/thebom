...
<body data-target="#nino-navbar" data-spy="scroll">
	...
	<section id="portfolio" class="section archive page">
		<div class="container">
			<div class="row">
				<h3 style="color: gray">일지</h3>
				<div class="pull-right mb5">
					<a href="dailylog_insert" class="btn btn-info search-button"> <span
						class="glyphicon glyphicon-user"></span> 일지작성
					</a>
				</div>
				<!-- Start table -->
				<div class="notice_container">
					<table class="table table-bordered mt5 table-hover">
						...
						<tbody>
							<c:forEach var="dailylog" items="${ dailylogs }">
								<tr data-url="dailylog_detail?dNo=${dailylog.DNo}">
									<td>${ dailylog.title }</td>
									<td>${ dailylog.content}</td>
									<td><fmt:formatDate pattern="yyyy-MM-dd"
											value="${dailylog.date}" /></td>
									<td>${dailylog.seniorName}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
